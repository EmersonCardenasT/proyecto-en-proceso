...
?>
    ...
    <div class="container-fluid bg-primary mb-5">
        <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 400px">
            <h3 class="display-3 font-weight-bold text-white">Nuestros docentes</h3>
            <div class="d-inline-flex text-white">
                <p class="m-0"><a class="text-white" href="index.php">Inicio</a></p>
                <p class="m-0 px-2">/</p>
                <p class="m-0">Nuestros docentes</p>
            </div>
        </div>
    </div>
    <!-- Header End -->
    ...
    <div class="container-fluid pt-5">
        <div class="container">
            <div class="text-center pb-2">
                <p class="section-title px-5"><span class="px-2">Docentes capacitados</span></p>
                <h1 class="mb-4">Interactua con nuestra plana de docencia</h1>
            </div>
            <div class="row">
            <?php foreach($listaLibros3 as $libro){ ?>
                <div class="col-md-6 col-lg-3 text-center team mb-5">
                    <div class="position-relative overflow-hidden mb-4" style="border-radius: 100%;">
                        <img class="card-img-top" src="administrador/CRUD2/img/<?php echo $libro['foto']; ?>" alt="" height="220px" width="100px" >
                        <div
    ...
    <div class="container-fluid py-5">
        <div class="container p-0">
            <div class="text-center pb-2">
                ...
                <h1 class="mb-4">Que opinan los padres!</h1>
            </div>
