       ...
       <div class="row no-gutters bg-dark">
            ...
            <div class="col-xl-7 col-lg-12 d-flex">
                <div class="container align-self-center p-6">
                    <h1 class="font-weight-bold">Registrar usuario nuevo</h1>
                    ...
                    <form  method="POST" action="">
                        ...
                        <div class="form-row mb-3">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" placeholder="Tu usuario" name="usuario">
                            </div>
                            <div class="form-group col-md-6">
                                <label class="font-weight-bold">Nombres <span class="text-danger">*</span></label>
                                <input type="text" class="form-control" placeholder="Tus nombres" name="nombre">
                            </div>
                        </div>
                        <div class="form-row mb-3">
                            <div class="form-group col-md-6">
                                <label class="font-weight-bold">Apellidos <span class="text-danger">*</span></label>
                                <input type="text" class="form-control" placeholder="Tus apellidos" name="apellido">
                            </div>
                            <div class="form-group col-md-6">
                        ...
                        <div class="form-group mb-3">
                            <label class="font-weight-bold">Confirma tu contraseña <span class="text-danger">*</span></label>
                            <input type="password" class="form-control" placeholder="Confirma tu contraseña" name="repContraseña">
                        </div>

                        <input type="submit" class="btn btn-outline-primary width-100" name="registrar" value="Registrar">
                        ...
                        <a href="login.php" class="btn btn btn-outline-info width-100">Volver al Login</a>
                    </form>
