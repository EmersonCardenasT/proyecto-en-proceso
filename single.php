...
?>
    ...
    <div class="container-fluid bg-primary mb-5">
        <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 400px">
            <h3 class="display-3 font-weight-bold text-white">Historia</h3>
        ...
        <div class="row pt-5">
            <div class="col-lg-8">
                <div class="d-flex flex-column text-left mb-3">
                    <p class="section-title pr-5"><span class="pr-2">Nuestra historia</span></p>
                    <h1 class="mb-3">Conoce el camino que recorremos</h1>
                    <div class="d-flex">
                ...
                <div class="mb-5">
                    ...
                    <h2 class="mb-4">De la mano de Dios</h2>
                    ...
                    <h3 class="mb-4">Educacion cristiana</h3>
                ...
                <div class="mb-5 mx-n3">
                    <h2 class="mb-4 ml-3">Opioniones acerca de nosotros</h2>
                ...
                <div class="bg-light p-5">
                    <h2 class="mb-4">Ingresa un comentario</h2>
                    <form>
                        ...
                        <div class="form-group">
                            ...
                            <input type="url" class="form-control" id="website" name="telefono">
                        </div>
