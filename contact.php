        ...
        <div class="row">
            <div class="col-lg-7 mb-5">
                <div class="contact-form">
                    ...
                    action="enviar_correo/enviarCorreo.php">
                        ...
                        <div class="control-group">
                            <textarea class="form-control" rows="6" name="mensaje" placeholder="Telefono y mensaje"
                             required="required" data-validation-required-message="Please enter your message"></textarea>
                        </div>
                        <div>
                            <input type="submit" class="btn btn-primary py-2 px-4" id="sendMessageButton" 
            ...
            <div class="col-lg-5 mb-5">
                <p>Para mayor informacion puedes enviarnos un correo electronico y con gusto recibiremos su mensaje,
                    tambien tienes otras opciones como escribirnos al Whatsapp, nuestra direccion, y el horario de atencion.</p>
                <div class="d-flex">
